...
router.post('/getESUserAgePopulation', result({
	'dataList|9': [{
		...
		'population|2000-15000': 0,
		'ratio|5-50': 0
	}],
	'totalPopulation|50000-100000': 0
}))
...
router.post('/getESOperationSummaryData', result({
	'operationSummary': {
		...
		'mall': '中石化',
		'terminalNum': 1,
		'totalPopulation|20000-500000': 0,
		'stayPopulation': 0,
		'averageStayTime': 0,
		'clickPopulation': 0,
